...
fig.update_layout(
    title='USA - GRAVITY (1/d potential) - RAW Height, LOG Color',
    scene=dict(
...
output_path = 'output/usa_triangle_centers_gravity.html'
fig.write_html(output_path)
log(f'\n✓ Saved to {output_path}')
log(f'\nDONE! USA gravity potential (1/d) visualization complete.')
log(f'This version uses literal gravity (1/d^2 force -> 1/d potential)')
log(f'Should produce Mt. Fuji-shaped peaks suitable for 3D printing!')
