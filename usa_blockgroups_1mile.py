#!/usr/bin/env python3
"""USA Block Groups - sample at block groups with 1 mile min_distance."""
import sys
...
potentials = potential.calculate_potential_chunked(
    ...
    n_jobs=2  # Limit to 2 cores to avoid overwhelming system
)
...
fig.update_layout(
    title='USA Block Groups Population Potential (1 mile smoothing)',
    scene=dict(
...
output = 'output/usa_blockgroups_1mile.html'
